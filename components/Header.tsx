        ...
        <div className="hidden lg:flex items-center gap-2">
          ...
          {onOpenFeedbackReview && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-muted-foreground bg-muted rounded-lg hover:text-foreground hover:bg-card-hover transition-colors"
              title="Review tester feedback"
            >
